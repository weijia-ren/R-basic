...
download.file("http://dss.princeton.edu/training/students.xls",
              "C:/Users/ren_w/Desktop/R code/Rmanipulation/data/students.xls",
              method="auto",
              quiet=FALSE,
              mode = "wb",
              cacheOK = TRUE)
...
# 2. from CSV
csv <- read.csv("C:/Users/ren_w/Desktop/R code/Rmanipulation/data/students.csv", header=TRUE)
...
library(sas7bdat)
sas <- read.sas7bdat("C:/Users/ren_w/Desktop/R code/Rmanipulation/data/test.sas7bdat") # don't work
library(haven) 
sas <- read_sas("C:/Users/ren_w/Desktop/R code/Rmanipulation/data/test.sas7bdat")
...
# 4. to SAS
library(haven) 
write_sas(sas, "C:/Users/ren_w/Desktop/R code/Rmanipulation/data/sas_write.sas7bdat")
